#
#  Be sure to run `pod spec lint wcdbframework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "852784647@qq.com" => "852784647@qq.com" }
  ...
  s.source_files  = "wcdbframework/WCDB.framework/Headers/*.{h}", "wcdbframework/sqlcipher.framework/Headers/*.{h}"
